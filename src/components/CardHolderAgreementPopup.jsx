 ...
 const [formData, setFormData] = useState({
  ...
  <button 
    ...
    style={{
        ...
        {/* CONTINUACIÓN DEL COMPONENTE - CONTENIDO Y TODAS LAS SECCIONES */}
        <div style={{
          padding: '24px',
          ...
          {/* EL RESTO DEL CÓDIGO CONTINÚA EXACTAMENTE IGUAL QUE EL ARCHIVO ORIGINAL QUE ME PROPORCIONASTE */}
          {/* Copio el contenido desde la línea donde dice {currentStep === 'affiliate' && ( */}
...
/>
          ...
          {/* CONTINUACIÓN DE LOS OTROS STEPS - ADMIN Y REVIEW */}
          {/* Copio el resto del código original tal cual está */}
