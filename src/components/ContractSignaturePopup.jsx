...
const ContractSignaturePopup = ({ isOpen, onClose, brokerData, onSignComplete, currentUser }) => {
  ...
  const downloadPDF = () => {
    // Crear elemento con el contenido completo del contrato
    ...
    element.innerHTML = `
      <div style="padding: 40px; font-family: Arial, sans-serif; font-size: 12px; line-height: 1.4; color: #000;">
        ...
        <!-- Aquí incluirías el resto del contenido del contrato -->
        
        <div style="margin-top: 40px; padding-top: 20px; border-top: 2px solid #333;">
          <h3 style="font-size: 14px; font-weight: bold; margin-bottom: 20px;">SIGNATURES</h3>
          
          <div style="display: flex; justify-content: space-between;">
            <div style="width: 45%;">
              <p><strong>RESELLER:</strong></p>
              <p>Name: ${brokerName}</p>
              <p>Company: ${brokerData.company_name}</p>
              <p>Date: ${getCurrentDate()}</p>
              <p>Initial: ${brokerInitials} - I have understood the document</p>
              ${signatureData ? `<img src="${signatureData}" style="max-width: 200px; height: 60px;">` : ''}
            </div>
            
            ${isAdmin && adminSignature ? `
            <div style="width: 45%;">
              <p><strong>EASY TRADELINES (Admin):</strong></p>
              <p>By: ${adminName}</p>
              <p>Date: ${getCurrentDate()}</p>
              <p>Initial: ${adminInitials} - I have understood the document</p>
              <img src="${adminSignature}" style="max-width: 200px; height: 60px;">
            </div>
            ` : ''}
          </div>
        </div>
    ...
    if (typeof html2pdf !== 'undefined') {
      ...
      alert('Para descargar el PDF, por favor incluya la biblioteca html2pdf en su proyecto');
    }
  };
    ...
    <div style={styles.overlay} onClick={onClose}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.content}>
          ...
          {/* Aquí va todo el contenido del contrato - las secciones 1-13 */}
          {/* Lo omito por brevedad pero deberían estar todas las secciones aquí */}
